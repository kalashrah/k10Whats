...
@class AVAudioPlayer, CMMotionManager, NSCache, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, NSTimer, WAAudioActivity, WACallInfo, WACallNotificationManager, WACallProviderDelegate, WATimer, WAVideoCaptureView;
...
+ (_Bool)isIOSNativeBoundsEnabled;
...
@property _Bool enableIOSNativeBounds; // @synthesize enableIOSNativeBounds=_enableIOSNativeBounds;
...
- (_Bool)callProviderAvailableWithVideo:(_Bool)arg1;
- (id)getCallInfo;
...
- (void)uninitializeEndedCallID:(id)arg1;
...
- (void)generateAndSendMessage:(void *)arg1 messageLength:(int)arg2 toPeer:(const char *)arg3 withEncryptionElement:(char *)arg4 length:(int)arg5 retryCount:(unsigned int)arg6;
