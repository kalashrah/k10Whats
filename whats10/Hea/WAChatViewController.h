...
- (id)vCardMatchCell;
- (id)reportSpamCell;
- (double)contentHeightForChatCellData:(id)arg1 canBeEstimate:(_Bool)arg2;
...
- (void)legacyPromptToSelectGroupAdmin;
...
- (float)pttRecorderAverageMeterLevelForChatMessageInputView:(id)arg1;
